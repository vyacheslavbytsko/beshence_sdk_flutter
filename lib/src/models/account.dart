...
class BeshenceAccount {
  ...
  BeshenceAvatar avatar({Key? key, double radius = 16.0}) => BeshenceWidgets.avatar(key: key, account: this, radius: radius);
  BeshenceAvatarButton avatarButton({Key? key, Function()? onPressed}) => BeshenceWidgets.avatarButton(key: key, account: this, onPressed: onPressed);
}
